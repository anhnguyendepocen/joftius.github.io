---
title: "Lecture 33 - Pitfalls of regression"
...
- **How could we address this problem?** Regression, including every possible confounding variable as a predictor
...
- How could we control for a grouping variable, like states? Include categorical predictor. What does this do?

## Association is not causation

- Remember the chocolate and Nobel prize [example](http://www.biostat.jhsph.edu/courses/bio621/misc/Chocolate%20consumption%20cognitive%20function%20and%20nobel%20laurates%20%28NEJM%29.pdf)?

- It seems funny because it's *obviously* wrong, but what about life expectancy and GDP?
