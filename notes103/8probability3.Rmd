...
- Suppose the population is 1,000,000, and 1,000 have outstanding warrants $W$
- Suppose therefore that on a given day there are 100,000 photos input to the algorithm, and 100 of these have $W$
- All 100 of these are matches $M$
- But also... 1\% of the 100,000 without $W$ *also* match $M$
- 1,100 matches total, but only 100 of them have $W$
- $P(W | M) = 0.01$
- If police are dispatched to arrest every one of these matches, only 1 out of every 100 of those arrests would be warranted
...
- Suppose we have 3 manufacturers producing computer chips
